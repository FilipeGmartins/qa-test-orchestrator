...
export function SuiteForm({ project, suite, reload }: { project: Project; suite?: Suite; reload: () => void }) {
  ...
  const disabled = !canWrite || Boolean(project.archivedAt) || mutation.isPending;
